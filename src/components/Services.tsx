...
const services = [
  {
    ...
    description: "Custom web applications built with modern technologies, ensuring scalability, performance, and user experience.",
    icon: (
  ...
  },
  {
    ...
    description: "Streamlined CI/CD pipelines, infrastructure automation, and deployment strategies to accelerate your development lifecycle.",
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Scalable cloud infrastructure and DevOps solutions to optimize your applications and business processes.",
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Intelligent solutions powered by machine learning, natural language processing, and computer vision technologies.",
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Secure, decentralized applications, smart contracts, and cryptocurrency solutions for the modern digital economy.",
    icon: (
      <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
